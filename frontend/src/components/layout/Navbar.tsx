  ...
  <div className='relative bg-white'>
    <div className='w-full px-4 sm:px-6'>
      <div className='flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10'>
        ...
        <nav className='hidden md:flex items-center justify-end lg:w-0 navbar'>
          <a href='/policies' className='text-base font-medium text-gray-500 hover:text-gray-900'>
            Policies
          </a>
          <a href='/login' className='ml-8 whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900'>
            Sign in
          </a>
          <a
            href='/register'
